...
export const EXPLORE_LIST_REQUEST = "EXPLORE_LIST_REQUEST";
export const EXPLORE_LIST_SUCCESS = "EXPLORE_LIST_SUCCESS";
export const EXPLORE_LIST_FAIL = "EXPLORE_LIST_FAIL";
